...
This is the released version 1.0 (July 1st, 2017) for the tool, and this version only supports analog eNVM devices (RRAM or PCM). For other devices such as SRAM, digital eNVM (RRAM, PCM or STT-MRAM) and FeFET, please go to released version 2.0 (May 1st, 2018) [MLP simulator (+NeuroSim) V2.0](https://github.com/neurosim/MLP_NeuroSim_V2.0) 
